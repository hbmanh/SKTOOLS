...
using SKToolsAddins.Parameters;
using static SKToolsAddins.Utils.ExcelRangeNameParseHelper;

namespace SKToolsAddins.Utils
{
    public static class FilterElementHelper
    {
        public static List<Element> Filter(UIDocument uidoc, RangeObject rngObj)
        {
            Document doc = uidoc.Document;
            if (rngObj.ObjectType == ObjectType.Reset)
            {
