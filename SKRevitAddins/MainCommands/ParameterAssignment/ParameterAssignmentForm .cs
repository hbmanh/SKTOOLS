...
using SKRevitAddins.ParameterAssignment;
...
namespace SKRevitAddins.Commands.ParameterAssignment
{
    public partial class ParameterAssignmentForm : Form
    {
        ...
        public List<CreateSharedParamFromExcelCmd.ParamObj> SelectedParameters { get; private set; }

        public ParameterAssignmentForm(List<CreateSharedParamFromExcelCmd.ParamObj> parameters, Document doc)
        {
            InitializeComponent();
            _doc = doc;
        ...
        {
            SelectedParameters = new List<CreateSharedParamFromExcelCmd.ParamObj>();
            ...
            foreach (DataGridViewRow row in dataGridView1.Rows)
            {
                if (row.Cells[0].Value != null)
                {
                    ...
                    var paramObj = new CreateSharedParamFromExcelCmd.ParamObj(parameterName, true);
